...
import love.math.manager.AnswerManager;
import love.math.manager.ChoiceManager;
import love.math.manager.QuestionManager;
import love.math.manager.UserManager;
...
public class Main {
    ...
    private static AnswerManager am;
    private static ChoiceManager cm;
    private static QuestionManager qm;
    private static User userConnected;

    public static void main(String[] args) {
        try {
            um = new UserManager(DataConnect.getConnection());
            am = new AnswerManager(DataConnect.getConnection());
            cm = new ChoiceManager(DataConnect.getConnection());
            qm = new QuestionManager(DataConnect.getConnection());
